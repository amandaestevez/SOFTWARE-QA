...
9. Click in "Apps" on the top menu and select "Xray" to go back to its settings.


9. In the Xray settings, go to "Issue Types Mapping" and connect the issue types you just created with Xray entities. Click "Save".
